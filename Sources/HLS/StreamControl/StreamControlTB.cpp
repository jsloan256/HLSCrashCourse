...
int main()
{
  ...
  StreamControlControlRegistersT AXI4Control;
  StreamControlControlRegistersT Control;

  StreamControlStatusRegistersT AXI4Status;
  StreamControlStatusRegistersT Status;
  ...
  for (i=0; i<5; i++)
  {
    StreamControlSyn(&AXI4Control, &Control, &AXI4Status, &Status);
