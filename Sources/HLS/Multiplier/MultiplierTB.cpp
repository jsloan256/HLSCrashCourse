...
void CalculateMultiplierControlRegisters(float Frequency, float Vp, MultiplierControlRegistersT<float, uint32_t>* AXI4Control)
{
  AXI4Control->Vp = Vp;
...
int main()
{
  int err = 0;
  int Ndx;
  MultiplierControlRegistersT<float,uint32_t> AXI4Control;
  MultiplierControlRegistersT<SigGenT, ap_uint<1> > Control;
  ...
  CalculateMultiplierControlRegisters(Frequency, Vp, &AXI4Control);
